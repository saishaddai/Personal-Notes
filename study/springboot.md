...
**Repository vs DAO**: 
- 0In Spring Boot, the terms DAO (Data Access Object) and Repository are often used interchangeably. However, there is a subtle difference between the two: A DAO is a more general concept that refers to any object that provides a standardized interface for accessing and manipulating data in a database.
